# https://dacon.io/competitions/official/235697/codeshare/2353?page=1&dtype=recent&ptype=pub
...
dirty_mnist_answer = pd.read_csv('D:/aidata/dacon12/dirty_mnist_2nd/dirty_mnist_2nd_answer.csv')
# dirty_mnist라는 디렉터리 속에 들어있는 파일들의 이름을 
# namelist라는 변수에 저장
namelist = os.listdir('../data/csv/dacon12/dirty_mnist/')
