...
# npy 불러와서 지정 =====================================
x = np.load('../data/npy/dirty_mnist_train_all(50000).npy')[:100]/255
...
# x 전처리 =====================================
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.1, shuffle=True, random_state=311)
...
# predict 엑셀로 저장 =====================================
# all_train 불러오기
all_test = np.load('../data/npy/dirty_mnist_test_all(5000).npy')[:100]/255
...
# p5_0211_1
#  loss, acc:  46.92182159423828 0.6000000238418579