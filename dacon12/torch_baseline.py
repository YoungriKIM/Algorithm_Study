...
trainset = MnistDataset('data/train', 'D:/aidata/dacon12/dirty_mnist_2nd/dirty_mnist_2nd_answer.csv', transforms_train)
testset = MnistDataset('data/test', 'D:/aidata/dacon12/submission/sample_submission.csv', transforms_test)
